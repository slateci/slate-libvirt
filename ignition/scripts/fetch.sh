...
wget -qN "https://pkg.cfssl.org/${CFSSL_RELEASE}/cfssljson_linux-amd64" -O /opt/slate/bin/cfssljson
chmod +x /opt/slate/bin/{cfssl,cfssljson,crictl,kubeadm,kubelet,kubectl}
